...
class MotionFinder:
    def __init__(self, history_length=2, thres=20, iou_thres=0.66):
    ...
    def get_motion_status(self, bboxes_raw, image):
        result = []
        bboxes = bboxes_raw['det']
        for bbox1 in bboxes:
            bbox1_x1, bbox1_y1, bbox1_x2, bbox1_y2, bbox1_conf, bbox1_cls = bbox1
            bbox_ret = [bbox1_x1, bbox1_y1, bbox1_x2, bbox1_y2, bbox1_conf, bbox1_cls, 1]
            for bbox2 in self.__bboxes_prev:
                bbox2_x1, bbox2_y1, bbox2_x2, bbox2_y2, bbox2_conf, bbox2_cls = bbox2
                ...
                if iou > self.__iou_thres and bbox1_cls == bbox2_cls:
                    if self.__image_prev is not None:
                        ...
                        if is_moving:
                            ...
                            bbox_ret = [bbox1_x1, bbox1_y1, bbox1_x2, bbox1_y2, bbox1_conf, bbox1_cls, 0]
                    else:
                        bbox_ret = [bbox1_x1, bbox1_y1, bbox1_x2, bbox1_y2, bbox1_conf, bbox1_cls, 1]
